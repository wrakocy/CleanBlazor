...
Building from an empty repo? Full detail lives in `docs/02-bootstrap-guide.md` — this skill is
the condensed checklist. Generating instead from this repo via `dotnet new blazor-clean` (see
