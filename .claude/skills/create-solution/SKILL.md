...
Full detail lives in `docs/02-bootstrap-guide.md` — this skill is the
condensed checklist. Before starting, confirm with the user (or infer from their request) three
...
3. Anything else in `docs/README.md`'s "Decisions already made" section the
   user wants to override (auth provider, observability stack, UI framework).
